package com.kafka.sreamsImpl.kafkaConfig.webserver;


import com.google.gson.Gson;
import com.kafka.sreamsImpl.kafkaConfig.model.CustomerTransactions;
...
public class InteractiveQueryServer {
    ...
    private String getKeyValuesAsJson(String store) {
         String streamConcurrent = "stream-concurrent";

        ReadOnlyKeyValueStore<String, Long> readOnlyKeyValueStore =
                kafkaStreams.store(store, QueryableStoreTypes.keyValueStore.toString());
    ...
    private String fetchFromSessionStore(Map<String, String> params) {
        ...
        ReadOnlyKeyValueStore<String, Long> readOnlySessionStore=
                kafkaStreams.store("CountsKeyValueStore", QueryableStoreTypes.keyValueStore());
    ...
    private HostInfo getHostInfo(String storeName, String key) {
        KeyQueryMetadata metadata = kafkaStreams.queryMetadataForKey(storeName, key, stringSerializer);
